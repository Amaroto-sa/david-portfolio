    ...
    return (
        <section className="min-h-screen bg-black flex flex-col md:flex-row items-center justify-between px-8 py-20 lg:px-24">
            ...
            >
                ...
                <h1 className="text-5xl md:text-7xl text-white font-serif tracking-tight leading-tight flex flex-wrap gap-[0.2em]">
                    {settings.headline.split(" ").map((word, idx) => (
                        <span key={idx} className="overflow-hidden inline-flex pt-1 pb-2">
                            <motion.span
                                initial={{ y: "120%", opacity: 0 }}
                                animate={{ y: 0, opacity: 1 }}
                                transition={{ delay: 0.2 + (idx * 0.08), duration: 0.8, ease: [0.2, 0.65, 0.3, 0.9] }}
