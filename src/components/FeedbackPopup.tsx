        ...
        return (
            <>
                ...
                <motion.div
                    ...
                    className="fixed bottom-28 right-8 z-50 bg-green-500 text-white px-6 py-4 rounded-xl shadow-2xl flex items-center space-x-3 cursor-grab active:cursor-grabbing select-none"
                >
    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="fixed bottom-28 right-8 z-50 cursor-grab active:cursor-grabbing select-none"
            >
                {!isOpen ? (
                    <button
                    ...
                    <div className="bg-white dark:bg-black w-80 shadow-2xl rounded-2xl border border-gray-200 dark:border-gray-800 flex flex-col p-6 mb-2">
